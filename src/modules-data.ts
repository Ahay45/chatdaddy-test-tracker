...
const STATIC: Record<string, StaticConfig> = {
  ...
  broadcasts: {
    ...
    notes: 'Fully rebuilt. PauseResumeCountdown.tsx (live countdown, pause/resume controls) confirmed. AdvancedSettingsSection.tsx has respectTimezone + timezone window UI confirmed. Recipients modal, WABA tier, edit, analytics all done.',
  },
